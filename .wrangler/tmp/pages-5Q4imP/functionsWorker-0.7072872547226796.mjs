...
// ../.wrangler/tmp/bundle-EaA81f/checked-fetch.js
...
var sanitizeText = /* @__PURE__ */ __name((value, limit = MAX_TEXT_LENGTH) => {
  if (typeof value !== "string") return null;
  if (!value.trim()) return null;
  return value.slice(0, limit);
}, "sanitizeText");
var hashIp = /* @__PURE__ */ __name(async (ip) => {
...
// ../.wrangler/tmp/pages-5Q4imP/functionsRoutes-0.47735586507533956.mjs
var routes = [
  {
...
// ../../../usr/local/share/nvm/versions/node/v22.17.0/lib/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../usr/local/share/nvm/versions/node/v22.17.0/lib/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-EaA81f/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-EaA81f/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7072872547226796.mjs.map
